        ...
        <div className={styles["nav-bar-container"]}>
            ...
            <div className={styles["nav-bar-menu"]} ref={ref}>
                ...
                <div className={styles["nav-bar-options-down"]}>
                    ...
                    <div className={styles["nav-bar-button"]} onClick={() => {props.setFormOpen()}} style={{background: '#c37887'}}><div style={{color: 'white', fontSize: '18px', fontWeight: '600', textDecoration: 'none'}}>Newsletter</div></div>
            ...
            <div className={styles["nav-bar-options"]}>
                ...
                <div className={styles["nav-bar-button"]} onClick={() => {props.setFormOpen()}} style={{background: '#c37887', cursor: 'pointer'}}><div style={{color: 'white', fontSize: '18px', fontWeight: '600', textDecoration: 'none'}}>Newsletter</div></div>
