    ...
    return (
        <div className={styles["nav-bar-container"]}>
            ...
            <div className={styles["nav-bar-options"]}>
                ...
                <div className={styles["nav-bar-button"]} style={{background: '#c37887', cursor: 'pointer'}}><div style={{color: 'white', fontSize: '18px', fontWeight: '600', textDecoration: 'none'}}>Newsletter</div></div>
